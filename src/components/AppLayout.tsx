  ...
  return (
    <div className="flex flex-col h-screen">
      <Box className="flex flex-row gap-4  items-center p-4 sticky top-0 z-10 " style={{ backgroundColor: 'var(--mantine-color-dark-6)', height: '5vh', minHeight: '80px' }}>
        <img src="https://cdn.7tv.app/emote/01G7HBWGZ8000DJJQKZ99T0A2Y/2x.webp" alt="Logo" className="w-12 h-12 rounded-lg drop-shadow-lg drop-shadow-black/60" />
        ...
        <Box className="flex flex-row gap-4 w-80">
          <NavLink
            ...
            label="Home"
            leftSection={<img src="https://cdn.7tv.app/emote/01GQS0ES780009VDYS78D30Z8Z/1x.webp" />}></NavLink>
          <NavLink
            href="/commands"
            className="text-lg rounded-lg"
            active={location.pathname === '/commands'}
            label="Commands"
            leftSection={<img src="https://cdn.7tv.app/emote/01FJAV4EJG000FZHS49NWQRPND/1x.webp" />}></NavLink>
        </Box>
      </Box>
